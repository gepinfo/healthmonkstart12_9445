...
{ path : 'addprogress', loadChildren: () => import('./addprogress/addprogress.module').then(m => m.AddprogressModule), canActivate: [AuthGuard] } , 
{ path : 'desktopview', loadChildren: () => import('./desktopview/desktopview.module').then(m => m.DesktopviewModule), canActivate: [AuthGuard] } , 
];
